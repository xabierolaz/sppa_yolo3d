...
primitive actor (Semantic Primitive Proxy Assembly, SPPA) in
...
external meshes at this sample size: SPPA scores \(0.413\) (CI
\([0.359,0.467]\)) against Generic graph \(0.370\) (CI \([0.335,0.405]\)), a
...
evidence: SPPA does \emph{not} win the reprojection metric on this
stream (\(0.298\)
